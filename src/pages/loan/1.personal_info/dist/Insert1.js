    ...
    var Insert = function (data) {
        try {
            var dataQuery = {
                ...
                married_couple_dateofbirth: MarriedCoupleDateOfBirth,
            ...
            var result2 = _1_personal_info_1.schema.safeParse(data);
            console.log(result);
            console.log(result2);
        }
        catch (err) {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("form", { onSubmit: handleSubmit(Insert) },
                ...
                React.createElement("fieldset", null,
                    React.createElement(material_1.Box, { sx: {
                        ...
                        React.createElement(react_hook_form_1.Controller, { name: "id", control: control, render: function (_a) {
                                ...
                                return (React.createElement(material_1.TextField, __assign({ onChange: onChange, onBlur: onBlur, value: value, id: "outlined-basic" }, register("id"), { label: "id", type: "text", error: !!errors.id, helperText: (_b = errors.id) === null || _b === void 0 ? void 0 : _b.message, variant: "outlined", size: "small" })));
                            } }),
                        React.createElement(react_hook_form_1.Controller, { name: "firstname_LA", control: control, render: function (_a) {
                                var _b;
                                var _c = _a.field, onChange = _c.onChange, onBlur = _c.onBlur, value = _c.value;
                                return (React.createElement(material_1.TextField, __assign({ id: "outlined-basic", label: "firstname_LA", type: "text" }, register("firstname_LA"), { error: !!errors.firstname_LA, helperText: (_b = errors.firstname_LA) === null || _b === void 0 ? void 0 : _b.message, variant: "outlined", size: "small" })));
                            } }),
                        ...
                        React.createElement(react_hook_form_1.Controller, { name: "gender_id", control: control, render: function (_a) {
                                ...
                                return (React.createElement(Autocomplete_1["default"], { sx: { width: 150 }, options: gender_id, onChange: function (e, value) {
                                        ...
                                        var _a;
                                        return (React.createElement(material_1.TextField, __assign({}, params, { label: "Choose a gender_id" }, register("gender_id"), { slotProps: {
                                                htmlInput: __assign(__assign({}, params.inputProps), { autoComplete: "new-password" })
                                            }, error: !!errors.gender_id, helperText: (_a = errors.gender_id) === null || _a === void 0 ? void 0 : _a.message, size: "small" })));
                                    } }));
                            } })),
                    React.createElement(material_1.Box, { sx: {
                            display: "flex",
                        ...
                        React.createElement(react_hook_form_1.Controller, { name: "dateofbirth", control: control, render: function (_a) {
                                ...
                                return (React.createElement(LocalizationProvider_1.LocalizationProvider, { dateAdapter: AdapterDayjs_1.AdapterDayjs },
                                    React.createElement(DatePicker_1.DatePicker, __assign({ sx: { width: 200, height: 50 }, defaultValue: yesterday, views: ["year", "month", "day"], slotProps: {
                                            textField: {
                                                helperText: "DD/MM/YYYY"
                                            }
                                        } }, register("dateofbirth"), { label: "dateofbirth", onChange: function (value) {
                                            setDateOfBirth(dayjs_1["default"](value));
                                        } }))));
                            } }),
            ...
            React.createElement(material_1.Stack, { spacing: { xs: 1, sm: 1, p: 1 }, direction: "row", useFlexGap: true, sx: { flexWrap: "wrap", justifyContent: "center" }, className: style_module_css_1["default"].ContorllerTexBox },
                React.createElement(material_1.Button, { variant: "contained", type: "submit", startIcon: React.createElement(icons_material_1.Save, null), onClick: handleSubmit(Insert) }, "Insert"),
