...
function DraggableDialog(_a) {
    ...
    var _x = react_hook_form_1.useForm({ resolver: zod_1.zodResolver(_1_personal_info_1.schema) }), reset = _x.reset, register = _x.register, control = _x.control, handleSubmit = _x.handleSubmit, errors = _x.formState.errors;
