...
var D2_collateral_categories_1 = require("../../../api/loan/DataSet/D2.collateral_categories");
        ...
        React.createElement(FormInsert_1["default"], { title: "enterprise_info" },
            React.createElement("form", { onSubmit: handleSubmit(onSubmit) },
                React.createElement(material_1.Box, { sx: {
                    ...
                    React.createElement(react_hook_form_1.Controller, { name: "category_id", control: control, rules: { required: true }, render: function (_a) {
                            var _b = _a.field, onChange = _b.onChange, onBlur = _b.onBlur, value = _b.value, ref = _b.ref;
                            return (React.createElement(material_1.Autocomplete, { sx: { width: 150 }, options: D2_collateral_categories_1.get_data().data, autoHighlight: true, getOptionLabel: function (option) { return "" + option.value_LA; }, onChange: function (event, value) {
                                    ...
                                    var _a;
                                    return (React.createElement(material_1.TextField, __assign({}, params, register("category_id"), { label: "Choose a category_id", slotProps: {
                    ...
                    React.createElement(react_hook_form_1.Controller, { name: "name", control: control, render: function (_a) {
                            var _b;
                            var _c = _a.field, onChange = _c.onChange, onBlur = _c.onBlur, value = _c.value;
                            return (React.createElement(material_1.TextField, __assign({ id: "outlined-basic", label: "name", type: "text" }, register("name"), { error: !!errors.name, helperText: (_b = errors.name) === null || _b === void 0 ? void 0 : _b.message, variant: "outlined", size: "small" })));
                        } }),
                    React.createElement(react_hook_form_1.Controller, { name: "collateral_no", control: control, render: function (_a) {
                            var _b;
                            var _c = _a.field, onChange = _c.onChange, onBlur = _c.onBlur, value = _c.value;
                            return (React.createElement(material_1.TextField, __assign({ id: "outlined-basic", label: "collateral_no", type: "text" }, register("collateral_no"), { error: !!errors.collateral_no, helperText: (_b = errors.collateral_no) === null || _b === void 0 ? void 0 : _b.message, variant: "outlined", size: "small" })));
                        } }),
                ...
                React.createElement(material_1.Box, { sx: {
                    ...
                    React.createElement(react_hook_form_1.Controller, { name: "value", control: control, render: function (_a) {
                            var _b;
                            var _c = _a.field, onChange = _c.onChange, onBlur = _c.onBlur, value = _c.value, error = _a.fieldState.error;
                            return (React.createElement(material_1.TextField, __assign({ id: "outlined-basic", label: "value", type: "text" }, register("value"), { error: !!errors.value, helperText: (_b = errors.value) === null || _b === void 0 ? void 0 : _b.message, variant: "outlined", size: "small" })));
                        } })),
                React.createElement(material_1.Box, { sx: {
                        display: "flex",
                        alignItems: "center",
                    ...
                    React.createElement(react_hook_form_1.Controller, { name: "other_details", control: control, render: function (_a) {
                            var _b;
                            var _c = _a.field, onChange = _c.onChange, onBlur = _c.onBlur, value = _c.value, error = _a.fieldState.error;
                            return (React.createElement(material_1.TextField, __assign({ id: "outlined-basic", label: "other_details", type: "text" }, register("other_details"), { error: !!errors.other_details, helperText: (_b = errors.other_details) === null || _b === void 0 ? void 0 : _b.message, variant: "outlined", size: "small" })));
                        } }),
