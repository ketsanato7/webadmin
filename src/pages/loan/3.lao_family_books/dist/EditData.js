...
function DraggableDialog(_a) {
    ...
    var onSubmit = function (data) {
        ...
        console.log(result);
        apiMonday_1["default"]
            .post("/Village/update", result.data)
            .then(function (e) {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(material_1.IconButton, { "aria-label": "fingerprint", color: "info", onClick: handleClickOpenInsert },
            React.createElement(icons_material_1.Edit, null)),
            ...
            React.createElement(DialogContent_1["default"], { dividers: true },
                React.createElement("form", { autoComplete: "off", onSubmit: handleSubmit(onSubmit) },
                    ...
                    React.createElement(material_1.Stack, { spacing: { xs: 1, sm: 1, p: 1 }, direction: "row", useFlexGap: true, sx: { flexWrap: "wrap", justifyContent: "center" }, className: style_module_css_1["default"].ContorllerTexBox },
                        React.createElement(material_1.Button, { variant: "contained", sx: { width: "25ch" }, type: "submit", startIcon: React.createElement(icons_material_1.Edit, null) }, "Edit"),
