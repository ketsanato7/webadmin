                ...
                React.createElement("form", { onSubmit: handleSubmit(onSubmit) },
                    React.createElement(material_1.Stack, { spacing: { xs: 1, sm: 1, p: 1 }, direction: "row", useFlexGap: true, sx: { flexWrap: "wrap" } },
                        React.createElement(react_hook_form_1.Controller, { name: "id", control: control, render: function (_a) {
                                ...
                                return (React.createElement(material_1.TextField, __assign({}, field, register("id"), { id: "outlined-basic", label: "id", type: "text", error: !!errors.id, helperText: (_b = errors.id) === null || _b === void 0 ? void 0 : _b.message, variant: "outlined", sx: { width: "25ch" } })));
                            } }),
